package com.suresh.flightreservation.util;
...
public class EmailUtil {
	@Value("${com.suresh.flightreservation.itinerary.email.body}")
	private String EMAIL_BODY = "Please find your Itinerary attached.";

	@Value("${com.suresh.flightreservation.itinerary.email.subject}")
